...
const defaultLocale: LanguageCode = savedLocale || (browserLocale.startsWith('zh') ? 'zh-CN' : 'en-US');

const i18n: I18n<MessageSchema, {}, {}, string, false> = createI18n<[MessageSchema], LanguageCode>({
  legacy: false,
